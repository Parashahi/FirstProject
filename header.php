          ...
          <div class="col ms-5">
            <ul class="navbar-nav">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a href="#4" class="dropdown-item">Standard</a></li>
                <li><a href="#4" class="dropdown-item">Gold</a></li>
                <li><a href="#4" class="dropdown-item">Diamond</a></li>
              </ul>
              </li>   
